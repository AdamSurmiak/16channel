...
#ifndef _BLFUNCTIONS_H_
#define _BLFUNCTIONS_H_
 ...
 */
extern "C" bool _stdcall BL_GetUSBdeviceinfos(unsigned int USBindex, char*  pcompany, unsigned int* pcompanysize,
                                                    char*  pdevice,  unsigned int* pdevicesize,
                                                    char*  pSN,      unsigned int* pSNsize );
 ...
 * @return \ref ERR_NOERROR if successful, another value if failed, see \ref TErrorCodes_e .
 */
extern "C" int _stdcall BL_LoadFirmware( int ID, uint8* pChannels, int* pResults, uint8 Length, 
 ...
 * @return \ref ERR_NOERROR if successful, another value if failed, see \ref TErrorCodes_e .
 */
extern "C" int _stdcall BL_LoadTechnique ( int ID, uint8 channel, const char* pFName, TEccParams_t Params,
