...
typedef struct {
    ...
    int  TechniqueID;     /*!< Identifier of the technique who has generated the data. Must be used to identify the data format into the data buffer (see \ref TTechniqueIdentifier_e ) */
    int  ProcessIndex;    /*!< Index (0-based) of the process of the technique who has generated the data. Must be used to identify the data format into the data buffer */
 ...
 */
typedef struct {
    char ParamStr[64];/*!< string who defines the parameter label (see section 7. Techniques in PDF for a complete description of parameters available for each technique) */
